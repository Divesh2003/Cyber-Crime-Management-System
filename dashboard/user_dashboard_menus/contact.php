...
<body>	
  ...
  <div class="card">
    ...
    <div class="card-body text-center py-5">
      ...
      <h5 class="card-text">Ministry of Home Affairs</h5>
      <h5 class="card-text">Delhi</h5>
  ...
  <div class="card">
    ...
    <div class="card-body text-center  py-5">
      ...
      <h5 class="card-title">Mobile : 6306823101</h5>
