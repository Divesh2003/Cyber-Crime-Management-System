			    			...
			    			<div class="col">
			    				<label for="ps_name">Police Station Name</label>
			      				<select id="ps_name" class="form-control" name="ps_name" required="required">
			      					...
			      					<option value="lucknow">Alambagh</option>
			      					<option value="delhi">Rajori Garden</option>
			      					<option value="Bengaluru">Hebbal</option>
			      					<option value="Lucknow">Hazratganj</option>
			      					<option value="Lucknow">Faizabad Road</option>
			      					<option value="Jorhat">Jorhat</option>
			      					<option value="Bengaluru">Whitefield</option>
							...
							<div class="form-row">
								...
								<div class="col">
									<div class="custom-control custom-radio custom-control-inline">
		  							...
		  							<label class="custom-control-label" for="adhar_no">Aadhar No</label>
									</div>
								</div>
							</div>
